...
/***/ function(module, exports, __webpack_require__) {
	...
	var logEvents = __webpack_require__(7);
	var athleteEvents = __webpack_require__(33);
	var auth = __webpack_require__(36);
	var firstScreen = __webpack_require__(43);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://workit-log.herokuapp.com/',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexLogs = function onIndexLogs() {
	  api.index().then(ui.onSuccess).catch(ui.onError);
	};

	var onShowLogs = function onShowLogs() {
	  api.show().then(ui.onShowSuccess).catch(ui.onShowError);
	};
	...
	var onCreateLog = function onCreateLog(event) {
	  ...
	  api.create(data).then(function (response) {
	    ...
	    return store.log;
	  }).then(ui.onCreateSuccess).then(onIndexLogs).then(onShowLogs).catch(ui.onCreateError);
	};
	...
	var onDeleteLog = function onDeleteLog(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.destroy(data.log.id).then(ui.onDeleteSuccess).then(onIndexLogs).then(onShowLogs).catch(ui.onDeleteError);
	};
	...
	var onUpdateLog = function onUpdateLog(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.update(data.log.id, data).then(ui.onUpdateSuccess).then(onIndexLogs).then(onShowLogs).catch(ui.onUpdateError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexLogsHandlebars = __webpack_require__(11);
	var showLogsHandlebars = __webpack_require__(31);

	var onSuccess = function onSuccess(data) {
	  //  debugger;
	  $('#view-logs').css('display', 'initial');

	  var indexLogsHtml = indexLogsHandlebars({ logs: data.logs });
	  $('#world').html(indexLogsHtml);
	};

	var onCreateError = function onCreateError(response) {
	...
	var onDeleteError = function onDeleteError(response) {
	  console.error(response);
	...
	var onUpdateError = function onUpdateError(response) {
	  console.error(response);
	...
	var onShowSuccess = function onShowSuccess(data) {
	  ...
	  var showLogsHtml = showLogsHandlebars({ logs: data.logs });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</th>\n    <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_completed : stack1), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.workout : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.athlete : stack1)) != null ? stack1.given_name : stack1), depth0))
	    + " "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.athlete : stack1)) != null ? stack1.surname : stack1), depth0))
	    + "</td>\n  </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<thead>\n  <tr>\n    <th>Log ID</th>\n    <th>Date</th>\n    <th>Workout</th>\n    <th>Athlete</th>\n  </tr>\n</thead>\n<tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.logs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</tbody>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateAthlete = function onUpdateAthlete(event) {
	  event.preventDefault();

	  var data = getFormFields(event.target);
	  api.update(store.user.id, data).then(ui.onUpdateSuccess).then(logEvents.onShowLogs).then(logEvents.onIndexLogs).catch(ui.onError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logEvents = __webpack_require__(7);
	var workoutEvents = __webpack_require__(39);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  }).then(ui.signUpSuccess).catch(ui.emailFailure);
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (response) {
	    ...
	    return store.user;
	  }).then(ui.signInSuccess).then(workoutEvents.onGetWorkouts).then(logEvents.onShowLogs).then(logEvents.onIndexLogs).catch(ui.signInFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetWorkouts = function onGetWorkouts() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexWorkoutsHandlebars = __webpack_require__(42);

	var onIndexSuccess = function onIndexSuccess(data) {
	  $('#view-workouts').css('display', 'initial');

	  var indexWorkoutsHtml = indexWorkoutsHandlebars({ workouts: data.workouts });
